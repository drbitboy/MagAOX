...
#   define DEBUG_findClDevice
#   ifdef DEBUG_findClDevice
...
static void indiRun(void)
{
    ...
    /* Return if any handler returns a negative count of channels */
    ...
    if ((s = handle_driver_messages(s, &rs,& ws)) < 0) { return; }
